...
class PrintLabel(object):
    def __init__(self):
        ...
        self.doc_path = os.path.join(
            self.dir_path, 'analysis/data/subtask1_training_afterrevise.txt')
        self.class_map = {'疾病和诊断': 0, '影像检查': 1,
                          '实验室检验': 2, '手术': 3, '药物': 4, '解剖部位': 5}
        self.color_map = {0: Fore.RED, 1: Fore.GREEN, 2: Fore.YELLOW,
                          3: Fore.BLUE, 4: Fore.MAGENTA, 5: Fore.CYAN}
            ...
            if line.strip():
                ...
                for entity in entities:
                    ...
                    if overlap:
                        ...
                        print(
                            Fore.WHITE, origin_text[last_start:start_pos], file=write_file)
            ...
            for e in pred_entities:
                if e:
                    ...
                    if e_source != origin_text[e_begin:e_end]:
                        ...
                        print('pred=', e_source, 'ori=',
                              origin_text[e_begin:e_end])
                    else:
                        if last_start <= e_begin:
                            print(Fore.WHITE, origin_text[last_start:e_begin])
                            print(
                                Fore.WHITE, origin_text[last_start:e_begin], file=write_file)
